    ...
    <section className="py-20 px-6 max-w-7xl mx-auto border-t border-base-content/5">
      <div className="text-center mb-16">
        <h2 className="text-3xl font-extrabold text-base-content">
          Featured <span className="text-[#00a851]">Ebooks</span>
        </h2>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center mt-6 pt-4 border-t border-base-content/5">
                  ...
                  <Link
                    ...
                    className="px-4 py-2 text-xs font-bold tracking-wider uppercase text-white bg-[#00a851] hover:bg-[#008f44] rounded-xl transition-colors shadow-xs"
                  >
                    View Book
                  </Link>
                </div>
      ...
      <div className="flex justify-center mt-8 items-center mx-auto w-full pt-4 border-t border-base-content/5">
        <Link
          href={`/browse`}
          className="px-4 py-2 text-xs font-bold tracking-wider uppercase text-white bg-[#00a851] hover:bg-[#008f44] rounded-xl transition-colors shadow-xs"
        >
